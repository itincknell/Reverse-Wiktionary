...
Environment:
  ...
  COLLECTION_NAME                Default: reverse_wiktionary_sample_dummy_v6
  MODEL_NAME                     Default: local-preview/dummy-32
...
export COLLECTION_NAME="${COLLECTION_NAME:-reverse_wiktionary_sample_dummy_v6}"
export MODEL_NAME="${MODEL_NAME:-local-preview/dummy-32}"
